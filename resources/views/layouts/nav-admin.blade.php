...
<body>
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3">Book Store</a>
        <!-- Sidebar Toggle-->
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        <a class="nav-link" href="{{ route('admin.index') }}">
                            <div class="sb-nav-link-icon"><i class="fi fi-sr-stats"></i></div>
                            Dashboard
                        </a>
                        <a class="nav-link" href="{{ route('product.index') }}">
                            <div class="sb-nav-link-icon"><i class="fi fi-rr-boxes"></i></div>
                            Products
                        </a>
                        <a class="nav-link" href="{{ route('transaction.index') }}">
                            <div class="sb-nav-link-icon"><i class="fi fi-sr-comment-dollar"></i></div>
                            Transaction
                        </a>
                    </div>
                </div>
